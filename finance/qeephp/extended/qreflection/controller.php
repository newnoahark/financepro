...
class QReflection_Controller
{
     ...
     */
    function __construct(QReflection_Module $module, $controller_name, $submodule = null)
    {
        ...
        if ($submodule)
        {
            $this->_controller_file_path = "{$dir}/{$submodule}/{$controller_name}_controller.php";
        }
        else
        {
        ...
        $class .= 'Controller_';
        if ($submodule) $class .= ucfirst($submodule) . '_';
