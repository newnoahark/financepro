 ...
 * @version $Id: coll.php 2547 2009-06-10 09:24:29Z dualface $
 * @package core
 */
...
class QColl implements Iterator, ArrayAccess, Countable {
	...
	function append($data) {
		...
		if (is_array($data) || ($data instanceof Iterator)) {
			...
			throw new QException(__('"%s()" 的参数 "%s" 必须是 "%s"，但实际提供的是 "%s".', __METHOD__, '$data', '数组或实现了 Iterator 的对象', gettype($data)));
		}
