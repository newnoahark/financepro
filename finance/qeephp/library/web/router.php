<?php
// $Id: router.php 2419 2009-04-13 03:52:48Z dualface $
 ...
 * @version $Id: router.php 2419 2009-04-13 03:52:48Z dualface $
 * @package mvc
 */
...
class QRouter
{
     ...
     * @var string
     */
    protected $_udi_var_regex = '([a-z|0-9][a-z0-9|-]*)(.[a-zA-Z0-9]*|[a-zA-Z0-9]*)';
    ...
    protected $_udi_parts = array(
        ...
        QContext::UDI_SUBMODULE  => QContext::UDI_DEFAULT_SUBMODULE,
