<?php
/**
 * (c)2006 - 2014 PHPExcel版权
 *
 * 这个库是自由软件;你可以和/或重新分配
 * 修改它根据GNU Lesser General公开
 * 许可证是由自由软件基金会发布;
 * 2.1版本的许可,或(任您选)其后的版本。
 *
 * 这个库分布,希望这将是有用的,
 * 但是没有任何保证;没有即使的默示保证
 * 适销性或健身为特定目的。看到GNU
 * 较小的通用公共许可证的更多细节。
 * 
 * 你应该收到GNU Lesser General公共的副本
 * 许可连同这个库;如果不是,写信给自由软件
 * 基础,Inc . 51富兰克林街,五楼,波士顿02110 - 1301美国
 *
 * @category   PHPExcel
 * @package    PHPExcel
...
class PHPExcel{
	...
	/**
	 * 所有的宏代码(vbaProject。本文件中,这包括形式、代码等),零如果没有宏
	 ...
	 * 消除所有不需要的 cellXf 和之后更新 xfIndex 的所有单元格和工作簿中的列
	 */
