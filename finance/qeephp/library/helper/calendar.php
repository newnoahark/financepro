<?php
abstract class Helper_Calendar {
	static function today_is() {
		$config = Q::ini('appini/language');
		switch($config['default']) {
			case 'zh':
				return self::lunarcalendar(time());
				break;
			default:
	...
	static function lunarcalendar ($timestamp) {    
	  #农历每月的天数
	  $everymonth=array(
  ...
  return date("Y年m月d日 ")."<br />".$weekday[$cur_wday]."<br />".$mten[$everymonth[$j][14]].$mtwelve[$everymonth[$j][15]]."年 ".$nlmon."".$nlday;
