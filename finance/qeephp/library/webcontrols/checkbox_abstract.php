<?php
// $Id: checkbox_abstract.php 2113 2009-01-19 20:42:57Z dualface $
 ...
 * @version $Id: checkbox_abstract.php 2113 2009-01-19 20:42:57Z dualface $
 * @package webcontrols
 */
...
abstract class Control_Checkbox_Abstract extends QUI_Control_Abstract
{
	protected function _make($type)
	{
		...
		$out .= $this->_printAttrs('id, name, checked');
