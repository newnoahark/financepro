...
abstract class QUI_Control_Abstract {
	...
	protected function _printValue() {
		...
		return strlen($this->value) ? 'value="' . htmlspecialchars(($this->format ? Helper_Format::format($this->value, $this->format) : $this->value)) . '" ' : '';
	}
	 ...
	 * @return string
	 */
	protected function _printAttrs($exclude = 'id, name, value, format') {
